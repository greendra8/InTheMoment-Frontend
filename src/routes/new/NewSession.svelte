...
<div class="session-container">
	...
	<div class="session-card">
		...
		<div class="session-type-selector">
			...
			<button class:active={sessionType === 'hypnosis'} on:click={() => (sessionType = 'hypnosis')}>
...
<style>
	...
	.session-type-selector button i {
		font-size: 1.1rem;
		color: var(--text-secondary);
		transition: all 0.3s ease;
	}

	.session-type-selector button span {
		font-size: 0.95rem;
		font-weight: 500;
		color: var(--text-secondary);
		transition: all 0.3s ease;
	...
	.session-type-selector button.active i,
	.session-type-selector button.active span {
		color: var(--text-primary);
	}
