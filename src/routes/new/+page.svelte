		...
		<div class="session-card">
			...
			>
				...
				<div class="session-options">
					...
					{#if autoConfig && autoConfig.conversation && autoConfig.conversation.length > 0}
						<div class="pre-session-indicator">
							<div class="indicator-icon">
								<i class="fas fa-comment-dots"></i>
							</div>
							<div class="indicator-text">
								<span>Check-in conversation loaded</span>
								<small
									>{autoConfig.conversation.length} messages from your check-in will help personalize
									this session</small
								>
							</div>
						</div>
